					...
					<header>
						<div class="row">
							<div class="col-xs-12">
								...
								<br />
								<p>For a pdf copy of our menu, please <a href="#">click here</a><?php if( is_home() ){ ?>, or if you are interested in our gluten free options, visit our <a href="<?php echo get_term_link('gluten free', 'post_tag'); ?>">gluten free menu</a>.
								<?php } else { echo "."; } ?>
								</p><br />
