...
function patelinis_base_scripts() {
	...
	wp_enqueue_style( 'patellinis_bootstrap-style', get_template_directory_uri() . "/css/main.css" );

	wp_enqueue_style( 'patellinis_font_awesome-style', get_template_directory_uri() . "/font-awesome-4.7.0/css/font-awesome.min.css" );

	wp_enqueue_script( 'patelinis_main_js', get_template_directory_uri() . '/js/main.js', array(), '20170420', true );
