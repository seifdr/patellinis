	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
				...
				<?php 
					...
					for ($i=0; $i < 4; $i++) { 
						...
						echo '<div class="col-xs-6 col-sm-3">';
						    ...
						    echo '</a>';
						    echo '<div class="row"><div class="col-xs-12"><p class="text-center"><i class="fa fa-heart red" aria-hidden="true"></i>&nbsp;'. $obj['data'][$i]['likes']['count'] .'&nbsp;Likes</p></div>';
						   	//echo '<div class="col-xs-12 col-sm-6"><p class="text-right">'. $obj['data'][$i]['comments']['count'] .'&nbsp;Comments</p></div></div>';
							echo '</div>';   
			...
			<div class="row bottomFeature">
				...
				<div class="col-xs-12 col-sm-12 col-md-6"><?php  echo "<img class='img-responsive' src='". esc_attr( $bf_image['url'] )  ."' />" ?></div>
			</div>
			<?php 
